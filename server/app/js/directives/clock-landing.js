angular.module('app')
  .directive('clocklanding', function() {
    return {
      restrict: 'E',
      ...
      link: function(vm, element, attrs) {
        ...
        function startClock(id, endtime) { //function to start clock and pass in id of elements to be updated as well as endtime
          ...
          function updateClock() { //function to update clock and put updated time on the page
