      ...
      $(function() {
        $("#funFacts").typed({
          strings: [
            ...
            "William Howard Taft was one of 5 Cincinnati natives to be elected president, and in 1910, became the first president to throw out the first pitch on Opening Day.",

            "There are more than 140 chili restaurants in Cincinnati. Cincinnati-ans consume more than 2,000,000 pounds of chili each year and 850,000 pounds of shredded cheese.",

            "Over the Rhine, a once-bustling community of German beer brewers and pork packers built the nation's largest collection of 19th-century Italianate architecture.",

            "In 2014, The Eagle, Salazar, Taft's Ale House (located in a once-condemned German church in Over the Rhine, built in 1850).",

            "The Roebling Suspension Bridge was the longest worldwide and was later the prototype for the Brooklyxn Bridge after it was completed in 1867.",

            "Cincinnati hosted the first night baseball game played under lights in 1935.",

            "Local Cincinnatian's developed the American Cornhole Organization and Cincinnati is also the capital of the game.",

            "The University of Cincinnati was the first school in the United States to introduce a co-op program.",
            ...
            "Carmen Electra was born in Cincinnati and attended Princeton High School.",

            "Zagat Survey named the Cincinnati Zoo and Botancical Garden one of the top zoos in the nation.",

            "Cincinnati was the first city to deliver airmail July 4, 1835 (by hot air balloon).",

            "Kings Island is the largest amusement and waterpark in the Midwest.",

            "Nick Lachey was born in Cincinnati and graduated from School for the Creative and Performing Arts.",

            "Cincinnati is the first and only city to own their own Railroad (Cincinnati Southern 1880).",

            "Cincinnati was the first city in America to hold a songfest(1849).",
            ...
            "Rock musician Peter Frampton married his third wife, Tina Elfers, in Cincinnati in 1996, and lived in an Indian Hill mansion from 2000 to 2012.",
            ...
            "Glier's Goetta is primarily composed of ground meat and steel-cut oats, this dish originated with German settlers who immigrated to the Cincinnati area in the 19th century.",
            ...
            "Cincinnati Playhouse in the Park is the only two-time Tony Award winner outside of New York City (Regional Theatre Tony Award in 2004 and Best Revival of a Musical in 2007).",

            "Cincinnati Museum Center at Union Terminal received the National Medal for Museum and Library Service. The nation's highest honor for museums and libraries that make extraordinary civic, educational, economic, environmental and social contributions.",
