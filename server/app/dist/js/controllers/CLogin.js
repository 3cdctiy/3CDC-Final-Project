...
(function () {
  ...
  angular.module('app').controller('CLogin', function ($state, $auth, $location, toastr, FFormUtilities, FApi) {
    ...
    // ------------------------------------------------------------
    var submitGetUpdates = function submitGetUpdates(userID, answer) {
